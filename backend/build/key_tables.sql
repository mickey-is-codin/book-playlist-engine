...
DROP TABLE IF EXISTS import_book_authors;
...
DROP TABLE IF EXISTS import_authors;
...
DROP TABLE IF EXISTS import_shelves;
...
DROP TABLE IF EXISTS import_book_interactions;
...
DROP TABLE IF EXISTS import_books;